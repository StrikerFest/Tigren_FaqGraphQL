...
namespace Tigren\FaqGraphQL\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'faqgraphql/faq/edit';
    private const URL_PATH_DELETE = 'faqgraphql/faq/delete';
